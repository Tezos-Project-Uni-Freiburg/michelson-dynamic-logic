...
addElems : ShadowProg [ pair (list (base nat)) (base nat) ] []
                      [ pair (list ops)        (base nat) ] []
addElems = fct (D1 CAR)
...
Γ-Elems : Context
Γ-Elems = [ base mutez / base mutez / pair (list (base nat)) (base nat) ]

init-Elems : ⊎Prog-state
init-Elems = [ Γ-Elems , αstate (αenv β∅ 0 1 0∈ 1∈) addElems (2∈ ∷ [M]) [M] [] ]

addOne   : ShadowProg [ pair (base nat) (base nat) ] []
                      [ pair (list ops) (base nat) ] []
addOne   = fct (D1 CAR) ; fct (PUSH (base nat) 1) ; fct (D1 ADDnn)
         ; fct (D1 (NIL ops)) ; fct (D1 PAIR)
         ; end

Γ-One : Context
Γ-One = [ base mutez / base mutez / pair (base nat) (base nat) ]
...
Γ-One-sp : Context
Γ-One-sp = [ base mutez / base mutez / pair (base nat) (base nat) //
           [ base nat / base nat ] ]
