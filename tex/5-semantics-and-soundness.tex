...
of \AFun{αprog-step}. Hence, we pattern match against \ACon{refl} and parts of the arguments,
...
Figure~\autoref{fig:prog-step-soundness-if-none} shows the case for
